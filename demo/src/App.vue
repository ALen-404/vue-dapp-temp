...
import { MoreWalletConnector } from '../../src/connectors/moreWallet';
...
let connectors: Connector[] = [
  ...
  new MoreWalletConnector({
    appUrl: 'http://localhost:3000',
    walletName:'111',
    logoUrl:'https://trustwallet.com/assets/images/check.svg',
  ...
  new MoreWalletConnector({
    ...
    walletName:'222',
    logoUrl:'https://trustwallet.com/assets/images/check.svg',
    walletProvider:window.bitkeep&& window.bitkeep.ethereum
